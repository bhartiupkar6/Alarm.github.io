...
//Alarm set by user display in html
function addAlarmToDom( time, intervalId){
    const alarm = document.createElement("div");
    alarm.classList.add("alarm" , "md", "d-flex");
...
// alarm save to local storage.

function saveAlarm(time){
    const alarms = checkAlarms();

    alarms.push(time);
    localStorage.setItem("alarms", JOSN.stringify(alarms));
}

// fetching alarms from local
...
function deleteAlarmFromLocal(time) {
    ...
    localStorage.setItem("alaarms", JSON.stringify(alarms));
}
